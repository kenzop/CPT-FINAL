def setup():
    ...
    global LEFT_PRESSED, FLOOR, RIGHT_PRESSED, UP_PRESSED, stars, rectx, recty
    ...
    unkillable_enemies_spawn_points = ([[800, FLOOR[0]], [700, 250],
                                        [1000, 100]])
    enemy = [600, FLOOR[1]]
    enemy_size = 50
...
def unkillable_enemy1_hitbox():
    ...
    if (bulletX >= unkillable_enemies[0][0] and bulletX <=
            unkillable_enemies[0][0]+unkillable_enemies_size and
            bulletY <= unkillable_enemies[0][1]+bullet_size and
...
def unkillable_enemy2_hitbox():
    ...
    if (bulletX >= unkillable_enemies[1][0] and bulletX <=
            ...
            bulletY <= unkillable_enemies[1][1]+bullet_size and
...
def unkillable_enemy3_hitbox():
    ...
    if (bulletX >= unkillable_enemies[2][0] and
            ...
            bulletY <= unkillable_enemies[2][1]+bullet_size and
...
def shooter_enemy1():
    ...
    if (bulletX >= shooter[0][0] and bulletX <= shooter[0][0]+shooter_size and
            bulletY <= shooter[0][1]+bullet_size and
    ...
    if (shooter_bulletX[0] >= MEGAMAN_POSITION[0] and
            ...
            shooter_bulletY[0] <= MEGAMAN_POSITION[1]+bullet_size and
            shooter_bulletY[0] > MEGAMAN_POSITION[1]-bullet_size):
        level3_reset()
...
def level3():
    ...
    if draw_shooter_bullet[0] is True:
        fill(255)
        rect(shooter_bulletX[0], shooter_bulletY[0], bullet_size, bullet_size)
